...
nvim_cmp_source.get_debug_name = function() return "vim-dadbod-completion" end

function nvim_cmp_source:is_available() return true end

function nvim_cmp_source:get_trigger_characters(_) return { '"', "`", "[", "]", "." } end
